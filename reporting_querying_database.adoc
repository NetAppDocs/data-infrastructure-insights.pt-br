...
summary: Acesse o banco de dados de relatórios diretamente por meio de APIs, dispensando o Cognos para integrações personalizadas, relatórios automatizados e fluxos de trabalho avançados de análise de dados. 
...
[role="lead"]
Acesse o banco de dados de relatórios do Data Infrastructure Insights diretamente por meio de APIs compatíveis com OData v4, evitando a interface Cognos para maior flexibilidade. Isso possibilita integrações personalizadas, fluxos de trabalho de relatórios automatizados e análises de dados avançadas para usuários que precisam de acesso programático aos dados de sua infraestrutura.
...
A API de Relatórios do Data Infrastructure Insights segue o padrão link:https://www.odata.org/["OData v4"] (Open Data Protocol) para suas consultas ao banco de dados de relatórios. Para saber mais, confira link:https://www.odata.org/getting-started/basic-tutorial/["este tutorial"] sobre o OData.
