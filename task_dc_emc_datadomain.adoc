...
[role="lead"]
Este coletor de dados reúne informações de inventário de sistemas de armazenamento com deduplicação DELL EMC Data Domain. Para configurar este coletor de dados, existem instruções de configuração específicas e recomendações de uso que você deve seguir.
