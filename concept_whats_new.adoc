...
=== O Assistente de IA da DII está disponível para todos!

O Data Infrastructure Insights AI Assistant está disponível em versão prévia e agora inclui os seguintes aprimoramentos:

* Disponibilidade da região do Azure: para clientes cujo site DII está hospedado no Azure, o Assistente DII já está pronto para ajudar você.
* Até 7 dias de dados: O Assistente agora pode acessar até 7 dias de métricas de alta resolução, permitindo análises de dados e insights mais abrangentes.
