...
Página de detalhes para possível ataque de ransomware: -Visualização em "Tela": Os widgets de tabela exibem o objeto/agrupamento no lado esquerdo e os dados do objeto (atributos/métricas) no lado direito.
...
'''
Widget de valor com formatação image:Single-Value Widgets - Formatted.png["Widgets de valor único com formatação"]
