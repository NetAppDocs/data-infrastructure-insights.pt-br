...
summary: Importe painéis pré-configurados da galeria para obter rapidamente insights de negócios, ou importe painéis personalizados que você exportou para compartilhar configurações entre locatários. 
...
[role="lead"]
Acesse painéis predefinidos da galeria para obter rapidamente insights sobre sua infraestrutura ou importe painéis personalizados que você exportou de outros tenants. Os painéis da galeria são adaptados aos coletores de dados do seu ambiente e projetados para responder a perguntas específicas de negócios, enquanto os painéis exportados permitem que você compartilhe configurações úteis entre vários tenants.
