...
.. Observação: o instalador do agente deve ser baixado para uma pasta diferente da pasta que contém o agente em execução.
...
+
Por exemplo, se o agente estiver em execução em "/test_user/apps", o comando seria:
