...
[role="lead"]
O Data Infrastructure Insights oferece opções de suporte abrangentes, incluindo recursos de autoatendimento, fóruns da comunidade, documentação e suporte técnico. Acesse esses recursos de suporte selecionando *Help > Support* e considere ativar seu direito ao suporte para desbloquear assistência técnica por meio de tickets online e suporte telefônico.
...
É altamente recomendável que você marque a caixa para permitir que um NetApp Support Engineer acesse seu Data Infrastructure Insights site durante a sua sessão de suporte. Isso permitirá que o engenheiro solucione o problema e ajude você a resolvê-lo rapidamente. Enquanto o Support Engineer tiver acesso ao seu site, ele poderá executar todas as funções de nível de administrador.

Quando seu problema for resolvido ou sua sessão de suporte terminar, você poderá desmarcar a caixa.

Você pode solicitar suporte acessando o link:https://www.netapp.com/support-and-training/["NetApp site de suporte"]. Você precisa ter uma assinatura ativa do Data Infrastructure Insights.
