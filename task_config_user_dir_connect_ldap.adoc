...
+
** Instale link:http://ldaptool.sourceforge.net/["Explorador LDAP"] ou link:http://jxplorer.org/["Java LDAP Explorer"] em qualquer máquina Windows que possa se conectar ao servidor LDAP.
