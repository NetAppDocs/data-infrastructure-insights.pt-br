...
TIP: Após instalar um agente em um servidor/VM, Data Infrastructure Insights coleta métricas desse sistema, além de coletar de quaisquer coletores de dados que você configurar. Essas métricas são coletadas como métricas de "Nó".
