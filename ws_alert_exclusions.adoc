...
. Tipos de arquivo: suprimir alertas de adulteração de arquivos em tipos específicos <<file-types,Tipos de arquivo permitidos>>
...
image:ws_alert_exclusions_users.png["Usuários com exclusões de alerta"]

image:ws_alert_exclusions_paths.png["Caminhos de exclusão de alertas"]
