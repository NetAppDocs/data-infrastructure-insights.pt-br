...
summary: Exporte resultados de consultas, tabelas de painéis, página inicial e outros dados para arquivos .CSV para análise externa, geração de relatórios e integração com outros aplicativos usando processamento assíncrono. 
...
[role="lead"]
Exporte dados para arquivos .CSV a partir de consultas, widgets de tabelas de painéis e tabelas da página inicial para análise externa, geração de relatórios e integração com outros aplicativos. O processo de exportação assíncrono permite que você continue trabalhando enquanto grandes conjuntos de dados são processados em segundo plano.
