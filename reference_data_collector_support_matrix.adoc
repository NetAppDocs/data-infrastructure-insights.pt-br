...
.71+| fundação .7+| Partilha de ficheiros | Nome | Implementado | HTTPS |  
...
.5+| QTree | ID Qtree | Implementado | HTTPS | id único da qtree 
...
.10+| Armazenamento | IP | Implementado | HTTPS |  
...
.17+| Pool de storage | ID do conjunto de armazenamento | Implementado | HTTPS |  
...
.52+| desempenho .21+| Volume interno | Total de latência | Implementado | HTTPS |  
...
.16+| Armazenamento | Total de latência | Implementado | HTTPS |  
...
.15+| Disco do StoragePool | Espaço de armazenamento de objetos utilizado | Implementado | HTTPS |  
...
* Versão 9.16.1P1 da NetApp : Sexta-feira, 14 de fevereiro de 2025, 03:53:50 UTC
...
* Lançamento do NetApp Electricjellyfish__9.17.1: Dom 09 Mar 05:56:14 UTC 2025
