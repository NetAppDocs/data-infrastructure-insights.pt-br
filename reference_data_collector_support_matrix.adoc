...
* 4.3.1
* 4.3.3
* 4.4.1 Tipo de versão: suporte padrão
* 4.5.15 Tipo de versão: suporte estendido
* 4.5.18 Tipo de versão: suporte estendido
* 4.5.21 Tipo de versão: suporte estendido
* 4.5.24 Tipo de versão: suporte estendido
* 4.5.7 Tipo de versão: Extended Support Release
* 4.6.1 Tipo de versão: suporte estendido
* 9.5.15 Tipo de versão: suporte estendido
* 9.5.8 Tipo de versão: versão com suporte estendido
* 9.6.1 Tipo de versão: suporte estendido
...
* Brocade 6558
* Brocade 7800
* Switch de Extensão Brocade 7810
* Brocade 7840
* Brocade DCX
...
.86+| fundação .9+| Disco | Capacidade (GB) | Implementado | HTTPS |  
...
.13+| Pool de armazenamento | Incluir na capacidade DWH | Implementado | HTTPS |  
...
.18+| Volume | Identificador de política do AutoTier | Implementado | HTTPS |  
...
.4+| fundação .4+| Informações | Nome da fonte de dados | Implementado | HTTP/S | Informações 
...
.15+| desempenho .4+| Dados do nó de armazenamento | Taxa de acertos do cache total | Implementado | SSH |  
...
.110+| fundação .15+| Disco | Capacidade (GB) | Implementado |  |  
...
.7+| Nó de armazenamento | Tamanho do cache | Implementado | HTTPS |  
