...
summary: Configurando o coletor de dados Pure FlashBlade Storage 
---
...
[role="lead"]
Data Infrastructure Insights utiliza o coletor de dados Pure Storage FlashBlade para reunir dados de inventário e desempenho de clusters FlashBlade que expõem a versão 2 de sua API REST.
