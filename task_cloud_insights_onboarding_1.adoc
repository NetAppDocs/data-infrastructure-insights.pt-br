...
Após a criação do seu tenant, você poderá acessar o Portal NetApp BlueXP a qualquer momento e navegar até a seção correspondente. link:https://services.cloud.netapp.com["Serviços em Nuvem"] Na página, selecione *Ir para Data Infrastructure Insights*.
