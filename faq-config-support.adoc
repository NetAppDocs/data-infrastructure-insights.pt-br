...
summary: Perguntas frequentes sobre a configuração do Data Infrastructure Insights, suporte a dispositivos, impacto ambiental, permissões e recursos de coleta de dados. 
---
