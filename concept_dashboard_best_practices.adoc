...
summary: Aprenda as melhores práticas para encontrar as métricas certas, filtrar ativos com eficiência e configurar widgets para criar painéis de controle poderosos e informativos. 
...
[role="lead"]
Domine a criação de dashboards com estratégias comprovadas para encontrar as métricas certas, filtrar ativos com eficiência e configurar widgets para obter o máximo de insight. Essas práticas recomendadas ajudam você a criar dashboards mais eficazes que fornecem inteligência acionável sobre a infraestrutura.
