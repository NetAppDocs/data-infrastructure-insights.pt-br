...
Se você perceber que sua AU está bloqueada ao tentar se conectar à DII, tente adicionar esses endpoints ao seu proxy:
...
Os endpoints específicos do proxy do NetApp Console que você pode precisar estão listados na link:https://docs.netapp.com/us-en/console-setup-admin/reference-networking-saas-console-previous.html#update-endpoint-list["Administrador de Configuração do NetApp Console"] documentação.
