...
| Proprietário da conta | O mesmo que Administrador | O mesmo que Administrador | O mesmo que Administrador | O mesmo que Administrador, além de gerenciar a autenticação SSO e a configuração da Federação de Identidade. Também é possível atribuir proprietários adicionais, bem como adicionar clientes ao locatário principal do Provedor de Serviços Gerenciados (MSP). 
