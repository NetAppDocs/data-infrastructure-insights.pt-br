...
summary: Utilize o verificador de taxa de eventos SVM para medir as taxas de eventos NFS/SMB e determinar o dimensionamento ideal do agente antes de implantar os coletores de dados do Workload Security. 
