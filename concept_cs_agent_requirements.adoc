...
summary: Garanta que o ambiente de implantação do seu Agente de Segurança de Carga de Trabalho atenda aos requisitos mínimos de sistema operacional, CPU, memória e espaço em disco para desempenho e coleta de dados ideais. 
