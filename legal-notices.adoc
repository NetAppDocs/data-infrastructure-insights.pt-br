...
link:media/DII_ON-PREM_Notice_Nov2025.pdf["Aviso para Data Infrastructure Insights (anteriormente Cloud Insights), janela=_blank"]

link:media/DII_WS_Notice_Nov2025.pdf["Aviso para Segurança de Carga de Trabalho (anteriormente Cloud Secure), janela=_blank"]
