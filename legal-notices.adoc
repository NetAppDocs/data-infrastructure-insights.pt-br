...
link:media/DII_Notice-Sept_2025.pdf["Aviso para Data Infrastructure Insights (anteriormente Cloud Insights)"]

link:media/WS_Notice-Sept_2025.pdf["Aviso para Segurança de Carga de Trabalho (anteriormente Cloud Secure)"]
