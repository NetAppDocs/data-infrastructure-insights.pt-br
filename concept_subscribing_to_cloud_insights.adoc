...
* Inscreva-se em link:https://cloud.netapp.com/cloud-insights["*avaliação gratuita*"] um dos Insights da infraestrutura de dados para explorar os recursos disponíveis.
...
Para obter uma comparação completa dos recursos disponíveis nas edições Data Infrastructure Insights Basic e Premium, consulte a link:https://www.netapp.com/cloud-services/cloud-insights/editions-pricing["Preços do Data Infrastructure Insights"] página.
...
NOTE: Os dados do Data Infrastructure Insights coletados até o fim do período de carência permanecem intactos por 30 dias após o período de carência. Se você renovar sua assinatura dentro desse tempo, todos os seus dados até o momento em que o período de carência terminar estarão disponíveis para você.
...
A observabilidade do Data Infrastructure Insights mede o uso de acordo com o nível de armazenamentos em seu ambiente. Você pode ter armazenamentos que se enquadram em uma ou mais dessas categorias:
