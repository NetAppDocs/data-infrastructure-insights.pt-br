...
NOTE: O DII analisa todos os dados existentes na semana anterior à criação do monitor e identifica picos ou quedas significativas de dados com duração superior a 30 minutos — essas são consideradas anomalias. Durante a segunda semana (a fase de "aprendizado"), à medida que mais pontos de dados são coletados e analisados, há uma chance de aumento de "ruído" nos alertas. Esse "ruído" normalmente diminui à medida que mais dados são analisados nas semanas subsequentes.
