...
Um computador que execute uma versão licenciada de um dos seguintes:
...
Se você estiver utilizando o SELinux, recomenda-se executar os seguintes comandos no sistema da unidade de aquisição:
...
50 GB (100 GB recomendados)

Para Linux, o espaço de disco deve ser alocado desta maneira:

* /opt/netapp 10 GB (20 GB para ambientes grandes)
* /var/log/netapp 40 GB (80 GB para ambientes grandes)
* /tmp deve ter pelo menos 1 GB disponível durante a instalação


Seu sistema de arquivos pode usar algum espaço para sua sobrecarga. Estes são os espaços mínimos que devem estar _disponíveis_ antes da instalação.
| 50 GB 
